...
router.put('/profile', (0, validation_1.validate)(validation_2.updateProfileSchema), auth_controller_1.authController.updateProfile);
router.post('/change-password', (0, validation_1.validate)(validation_2.changePasswordSchema), auth_controller_1.authController.changePassword);
